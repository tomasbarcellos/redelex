...
test_that('Cria URN adequadamente', {
  expect_identical(criar_urn(titulo1), 'urn:br:lei;2008-06-19;11705')
})

test_that('Lida com datas incompletas', {
  expect_identical(criar_urn(titulo2), 'urn:br:lei;2008;11705')
})

test_that('Lida com datas ausentes', {
  expect_identical(criar_urn(titulo3), 'urn:br:lei;*;11705')
})
